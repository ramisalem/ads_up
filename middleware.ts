...
export default auth(async (req) => {
    ...
    if (
        ...
        req.nextUrl.pathname.indexOf('png') > -1 ||
        req.nextUrl.pathname.indexOf('svg') > -1 ||
        req.nextUrl.pathname.indexOf('jpg') > -1
...
export const config = {
    ...
    matcher: [
        ...
        // '/(ar|en)/:path*',
        // "/((?!api|auth|_next|.*\\..*).*)",
        '/((?!api|_next/static|_next/public/img|_next/image|favicon.ico).*)'
    ]
};
